...
* Ensure that your AWS account has sufficient permissions to use the ROSA CLI: xref:../cli_reference/rosa_cli/rosa-cli-permission-examples.adoc#rosa-cli-hcp-examples_rosa-cli-permission-examples[Least privilege permissions for common ROSA CLI commands]
...
* For more information about resources provisioned during ROSA cluster deployment, see xref:../rosa_planning/rosa-sts-aws-prereqs.html#rosa-aws-policy-provisioned_rosa-sts-aws-prereqs[Provisioned AWS Infrastructure].
...
=== Optional: Additional custom security groups
...
=== Optional: DNS and custom domains

//TODO OSDOCS-11789: Did my best with this but definitely need mmcneill's input
